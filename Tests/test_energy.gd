...
func test_add_energy() -> void:
	card = load("res://Cards/Resource/test_cards/Card_Energy.tres") # adds 70 energy
...
func test_using_energy() -> void:
	...
	card = load("res://Cards/Resource/test_cards/Card_Damage.tres")
